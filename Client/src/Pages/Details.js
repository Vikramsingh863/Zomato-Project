...
class Details extends React.Component {
    ...
    render() {
        ...
        menu && menu.length > 0 && console.log(menu)
        return (
            <div>
                {/* <!--Navbar--> */}
                ...
                >
                    ...
                    <div style={{ width: '20em' }}>
                        ...
                        <button className="btn btn-success" style={{ float: "right", marginTop: "18px" }} onClick={this.razorpayPayment}>Proceed</button>
                    </div>
                </Modal>
